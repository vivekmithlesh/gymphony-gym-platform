...
import { ownerSignupVerify } from "@/server/api/auth/owner-signup-verify";
...
function VerifyOtpPage() {
  ...
  useEffect(() => {
    const storedPhone = sessionStorage.getItem("ownerSignupPhone");
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      setIsLoading(true);
      const result = await ownerSignupVerify({
        data: {
          phone,
          code: otpCode,
        },
      ...
      sessionStorage.removeItem("ownerSignupPhone");
