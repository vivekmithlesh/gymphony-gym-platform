      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold tracking-tight md:text-5xl">
            Simple pricing. <span className="text-gradient-brand">Serious results.</span>
          </h2>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex items-baseline gap-2">
                  ...
                  <span
                    className={
                      p.highlighted ? "text-surface-foreground/70" : "text-muted-foreground"
                    }
                  >
                    {p.period}
                  </span>
                ...
                <p
                  className={`mt-3 ${p.highlighted ? "text-surface-foreground/80" : "text-muted-foreground"}`}
                >
                  {p.desc}
                </p>
