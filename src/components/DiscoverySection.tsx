                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-muted-foreground">
                        {selectedGym.rating} Star Rating
                      </span>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-xs font-bold uppercase tracking-widest text-primary">
                      Rank #{selectedGym.rank}
                    </span>
                  </div>
                </div>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            <h2 className="font-display text-4xl font-bold tracking-tight text-foreground md:text-5xl">
              Get discovered by{" "}
              <span className="text-gradient-brand bg-gradient-brand">new members</span>
            </h2>
            <p className="mt-6 text-lg text-muted-foreground">
              Don't just run a gym, build a brand. Gymphony puts your business in front of the
              largest fitness community in your city.
            </p>
            ...
            <div className="mt-12 space-y-6">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg ${feature.color}`}
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 rounded-2xl border-2 border-dashed border-primary/30 bg-primary/5 p-6 text-center">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    You are not ranked yet in Aligarh
                  </p>
